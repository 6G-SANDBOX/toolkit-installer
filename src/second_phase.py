...
def second_phase() -> None:
    ...
    if sixg_sandbox_group_data is not None:
        sixg_sandbox_group = msg("info", "Group already exists")
    ...
    if jenkins_user_data is not None:
        jenkins_user = msg("info", "User already exists")
